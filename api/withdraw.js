// api/withdraw.js — Season 4 single-step withdraw: a user types a WTC
// amount (minimum MIN_WITHDRAW_WTC) and submits directly. Two fees apply
// back-to-back (WITHDRAW_FEE_PERCENT then WITHDRAW_SECOND_FEE_PERCENT —
// see lib/constants.js for the full spec and the exact math). The first
