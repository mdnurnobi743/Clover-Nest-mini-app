...
// constants (search index.html for "mirrors lib/telegram.js").
...
// Public payment-proof channel — every APPROVED withdrawal is auto-posted
// here (lib/paymentProof.js). The bot must be an ADMIN of this channel with
// "Post messages" permission, otherwise Telegram rejects the post.
// Override with PROOF_CHANNEL_ID (e.g. a numeric -100… id) if needed.
export const PROOF_CHANNEL = process.env.PROOF_CHANNEL_ID || '@clovernestpaymentproof';
export const PROOF_CHANNEL_URL = 'https://t.me/clovernestpaymentproof';
